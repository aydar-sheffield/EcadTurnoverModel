%This script compares simulation results with different values of
%constant value for rest length (i.e. independent of tension) remodelling parameter
%This script was used to generated plots on Figure S2
close all;
clear all;
% Set font size
font_size = 18;
...
legend([pe, p,p1, p2, p3, p4], {'\textit{Exp. data}', '$1/k^{-}$=\textit{10min}','$1/k^{-}$=\textit{15min}',...
    '$1/k^{-}$=\textit{30min}','$1/k^{-}$=\textit{60min}','\textit{Release}'}, 'Interpreter', 'latex','FontAngle','italic');
axis([0 400 0.5 6.5])
set(gca,'FontSize',font_size)
set(gca, 'FontName', 'Arial')
set(gcf, 'Position', [1000 774 713 555]);
saveas(gcf,'Ratio_const_rates','fig');
saveas(gcf,'Ratio_const_rates','png');